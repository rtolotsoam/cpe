...
<head>
	...
	<script src="<?php echo js_url('library/jquery-ui/js/jquery-ui.min.js'); ?>"></script>
	<script src="<?php echo js_url('library/jquery-ui/js/jquery.ui.effect-bounce.js'); ?>"></script>
...
<body class="sidebar-mini" <?php if($titre == "PROCESSUS" && isset($dern)){ echo "onload=\"click_lien(".$dern.");\""; }?> style="background: #f5f5f5 url(<?php echo img_url("fond.png");?>) repeat-x fixed; background-position: 15px bottom;z-index:100000;">
